...
public class TensorMatrixProperties
{
    ...
    /// </summary>
    private DNATensor Tensor { get; set; }
    ...
    /// <returns></returns>
    public DNAMatrix this[int index]
    {
        get => GetMatrix(index);
    ...
    /// <returns></returns>
    public DNAMatrix this[int[] indexes]
    {
    ...
    public TensorMatrixProperties(DNATensor tensor)
    {
        Tensor = tensor;
    }
    ...
    /// </summary>
    public DNAMatrix[] Matrices
    {
        get
        {
            DNAMatrix[] matrices = new DNAMatrix[NumberOfMatrices];
    ...
    /// <returns></returns>
    /// <exception cref="IndexOutOfRangeException"></exception>
    public DNAMatrix GetMatrix(int matrixIndex)
    {
        if (matrixIndex < NumberOfMatrices)
    ...
    /// <returns></returns>
    /// <exception cref="IndexOutOfRangeException"></exception>
    private DNAMatrix CopyMatrix(int[] indexes)
    {
    ...
    /// <returns></returns>
    /// <exception cref="IndexOutOfRangeException"></exception>
    private DNAMatrix CopyMatrix(int index)
    {
    ...
    /// <exception cref="IndexOutOfRangeException"></exception>
    private void SetMatrix(int[] indexes, DNAMatrix matrix)
    {
    ...
    /// <param name="index"></param>
    /// <param name="matrix"></param>
    private void PasteMatrix(int[] indexes, DNAMatrix matrix)
    {
    ...
    /// <param name="index"></param>
    /// <param name="matrix"></param>
    private void PasteMatrix(int index, DNAMatrix matrix)
    {
